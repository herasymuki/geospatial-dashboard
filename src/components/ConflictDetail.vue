<template>
  <div class="detail-drawer" @click.self="store.clearSelection()">
    <div class="detail-panel">
      <button class="detail-close" @click="store.clearSelection()">✕</button>
      ...
      <div class="detail-meta">
        ...
        <div class="meta-item">
          <span class="meta-label">💀 Fatalities</span>
      ...
      <div class="detail-related" v-if="relatedEvents.length > 1">
        <h4>🗂 Other Events in {{ c.country }} ({{ relatedEvents.length }})</h4>
        <div class="related-list">
          <div v-for="e in relatedEvents.slice(0,5)" :key="e.id" class="related-item"
            ...
            <span class="related-fatal text-red">{{ e.fatalities }} 💀</span>
          </div>
        </div>
      </div>
